(function(){function k(){var t=n.channels.map(function(n){return{value:n.name,text:n.name}});showBootboxSelectPrompt("Switch chat user/channel.",t,"sm",i,function(n){n&&et(n)})}function d(){axios.get(`/api/sessions/pubnub-user/${v}`).then(function(t){n=t.data;it();i=ut();ot()}).catch(function(n){console.error(n.response.data)})}function g(t){axios.get(`/api/sessions/teammembers/${t.channel}`).then(function(i){n.teamMembers.push.apply(n.teamMembers,i.data);var r=h(t);f(r)}).catch(function(n){console.error(n.response.data)})}function y(n){var r={channel:i.name,message:n};t.publish(r,function(n,t){console.log(n,t)})}function nt(){var i=n.channels.map(function(n){return n.Name});t.fetchMessages({channels:i,end:o,count:25},(n,t)=>{var r,i,u;if(t){r=t.channels;i=[];for(const n in r)i.push.apply(i,r[n]);i=_.sortBy(i,"timetoken");console.log(i);u="";i.forEach(function(n){u+=tt(n)});$(".chat-box li").remove();f(u)}})}function tt(t){var f="",e,u,i,o;return t.message.publisher===n.uuId?(t.channel==="All"?(i=r("all-panelists"),e=""):(i=r(t.message.subscriber),e=`<span class="text-danger">(privately)</span>`),f=`<li>
                    <p>
            ...
            </li>`),f}function it(){t=new PubNub({publishKey:pKeys.publishKey,subscribeKey:pKeys.subscribeKey,uuid:n.uuId});t.addListener({status:function(n){n.category==="PNConnectedCategory"},message:function(t){var i,u;if(o||(localStorage.setItem("endTimeToken",t.timetoken),o=t.timetoken),t.publisher!==n.uuId)if(i=r(t.publisher),i){if(t.message.subscriber&&n.uuId!==t.message.subscriber)return;u=h(t);f(u)}else n.channels.push({name:t.channel}),g(t)},presence:function(n){var t=n.occupancy},membership:function(){},user:function(){}});w();p();l&&nt()}function p(){t.hereNow({channels:["All"],includeState:!0},function(n,t){var i,u,o,f,s,h;n.statusCode===200&&(i=t.channels.All,u=[],u.push({id:"",text:""}),o="",i.occupants.forEach(function(n){var t=r(n.uuid);t&&(u.push(t),o+=`<li class="list-inline-item text-primary border">${t.text}</li>`)}),f=e.val(),initSelect2(e,u,!1,"Select Team."),f==="all-panelists"?(e.val("all-panelists").trigger("change"),$("#chat-mode").text("(Publically)")):(s=r(f),s?(e.val(f).trigger("change"),$("#chat-mode").text("(Privately)")):(e.val("all-panelists").trigger("change"),$("#chat-mode").text("(Publically)"))),h=i.occupancy>0?i.occupancy-1:0,$("#totalOccupancy").html(h),$("#ul-online-users").empty().append(onlineUsersMarkup))})}function rt(n){t.subscribe({channels:[n],withPresence:!0})}function w(){t.subscribe({channels:n.channels.map(function(n){return n.name}),withPresence:!0})}function s(n){return`<li class="message-item me">
            ...
            </li>`}function f(n){$(".messages").append(n);a.update()}function ut(){return n.channels.find(function(n){return n.isDefault})}function ft(t){return n.channels.find(function(n){return n.name===t})}function r(t){return n.teamMembers.find(function(n){return n.uuId===t})}function et(n){i=n;$("#d-channel").text(n)}function c(n){var t=parseInt(n/1e7),i=new Date(t*1e3);return getChatTime(i)}function ot(){n.events.forEach(function(n){var i="",t="";n.cto&&(t+=`<div class="col-12">
                        <div class="py-3">
                            <h5>CTO</h5>
                            <p>${n.cto}</p>
                        </div>
                ...
                </div>`;$("#eventInfo").append(i);n.resources.length>0&&$(`#previewFile-${n.id}`).fileinput({showUpload:!1,theme:"fa",initialPreview:u,initialPreviewAsData:!0,initialPreviewFileType:"image",initialPreviewConfig:f})})}var t={},n={},i={},u={text:"",publisher:"",subscriber:""},e,b,o,l=!1,a,v;$(function(){localStorage.getItem("endTimeToken")&&(o=localStorage.getItem("endTimeToken"),l=!0);v=$("#eventId").val();d();var t=(new signalR.HubConnectionBuilder).withUrl("/channelHub").build();t.on("channelAdded",function(t){var i=ft(t);i||(n.channels.push(channel),rt(t))});t.start().then(function(){console.log("SignalR Started")}).catch(showResponseError);$("#txt-message").keyup(function(t){var i,r;if(t.preventDefault(),(t.keyCode||t.which)==13){if(i=this.value?this.value.trim():this.value,!i)return;u={text:i,publisher:n.uuId};y(u);this.value="";r=s(u);f(r)}});$("#btn-send").on("click",function(t){var i,r;(t.preventDefault(),i=$("#txt-new-message").val(),i)&&(u={text:i,publisher:n.uuId},y(u),$("#txt-new-message").val(""),r=s(u),f(r))});$(".chat-content .chat-body").length&&(a=new PerfectScrollbar(".chat-content .chat-body"));setInterval(p,15e3);$(".chat-content").toggleClass("show");$("#swith-user").on("click",k)})})();